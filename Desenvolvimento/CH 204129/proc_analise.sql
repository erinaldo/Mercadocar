...
--		[fmoraes]		31/10/2019	Modified
--			Alterado @Numero_Documento para receber INT
-- </history>   
-----------------------------------------------------------------------------------  
--CREATE PROCEDURE [dbo].[p_Venda_Tecnica_Consultar_Romaneio_Pesquisa_CH_204129]
--(  
--			@Lojas_ID								INT,
...
SET			@Lojas_ID								= 1
SET			@Data_Inicial_Pesquisa_Cliente			= '2019-10-01 00:00:00'
SET			@Data_Final_Pesquisa_Cliente			= '2019-10-31 23:59:00'
SET			@Enum_Tipo_Documento_Venda				= 934 --936 Cupom Fiscal, 937 Nota Fiscal, 935 Grupo, 934 Romaneio
SET			@Numero_Documento						= 999999999 -- RM 987665081 --GRP 91614167 --CF 1857 -- CPF 15408193888
