...
--		[fmoraes]		13/11/2019	Modified
--			Alterado para trazer as colunas Usuario_Aprovacao_Credito_ID e Enum_Tipo_Troca_ID
-- </history>   
-----------------------------------------------------------------------------------  
--CREATE PROCEDURE [dbo].[p_Venda_Tecnica_Consultar_Romaneio_Pesquisa_Demanda_202755_US02]
--(  
--			@Lojas_ID								INT,
...
SET			@Lojas_ID								= 1
SET			@Data_Inicial_Pesquisa_Cliente			= '2019-10-25 00:00:00'
SET			@Data_Final_Pesquisa_Cliente			= '2020-01-22 10:00:00'
SET			@Enum_Tipo_Documento_Venda				= NULL --936 Cupom Fiscal, 937 Nota Fiscal, 935 Grupo, 934 Romaneio
SET			@Numero_Documento						= NULL
SET			@Cliente_ID								= '8F30A989-B4C6-41C1-A348-71C5628BB71F'
SET         @Peca_ID								= NULL
--/*********************************************************************/
...
IF	@Enum_Tipo_Documento_Venda = @Enum_Tipo_Documento_Venda_Romaneio_ID 
		...
		SELECT DISTINCT
			...
			Romaneio_Venda_CT.Usuario_Aprovacao_Credito_ID          AS Usuario_Aprovacao_Credito_ID, 
			Romaneio_Venda_CT.Enum_Tipo_Troca_ID                    AS Enum_Tipo_Troca_ID
		FROM		
